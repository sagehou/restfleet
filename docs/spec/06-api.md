...
initialize 已实现，见 8.2；test/index/disable/PATCH/stats 以及 Agent 配置下发仍未交付，M4 尚未完成。见 [ADR-0011](../adr/0011-repository-records-and-ownership.md)。
